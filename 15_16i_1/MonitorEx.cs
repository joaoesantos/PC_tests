 ...
 * monitors with multiple condition variables.
 *
 * NOTE: This implementation has an importante limitation. it does not support waiting on
 *       condition variables of threads that have acquired the possession of the monitor
 *       more than once (when this situations happens the monitor's lock is not completely
 *       int Wait method).
 *
...
public static class MonitorEx {
	...
	//
	// This method is called with the mlock's lock held, and returns under
	// the same conditions.
